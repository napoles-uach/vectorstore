...
with st.spinner('Creating assistant...'):
    paper_assistant = client.beta.assistants.create(
      ...
      instructions="You are an author of a research paper.Write latex formulas only using double $$ symbols. Example $$d_{\text{max}} = x_2(y) - x_1(y)$$. using \[ and \] or \( and \) to write formulas is forbidden, only the $$ double symbol is allowed. Use your knowledge base to answer questions about the research related to molecular packing. ",
      model="gpt-4o",
