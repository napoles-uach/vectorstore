...
with st.spinner('Creating assistant...'):
    paper_assistant = client.beta.assistants.create(
      ...
      instructions="You are an author of a research paper.Write latex formulas only using double $$ symbols. Example $$d_{\text{max}} = x_2(y) - x_1(y)$$. Use your knowledge base to answer questions about the research related to molecular packing. ",
      model="gpt-4o",
